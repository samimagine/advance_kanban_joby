        ...
        files: [
            {
                ...
                date: '01/Feb/2024',
                description:
                    'Comprehensive design specifications for flight controller systems.',
                type: 'PDF',
            ...
            },
            {
                ...
                date: '15/Mar/2024',
                description:
                    "Detailed testing plan for the flight controller's quality validation.",
                type: 'DOC',
            ...
            },
            {
                ...
                date: '22/Mar/2024',
                description:
                    "Source code for the flight controller's embedded systems.",
                type: 'PDF',
                thumbnail: 'https://placehold.co/200x200?text=PDF',
            },
            {
                ...
                date: '10/Apr/2024',
                description:
                    'Analysis of surface treatment for flight controller housing.',
                type: 'DOC',
                thumbnail: 'https://placehold.co/200x200?text=DOC',
            },
        ],
        ...
        files: [
            {
                ...
                date: '12/Feb/2024',
                description:
                    'Detailed workflow for propulsion system engineering.',
                type: 'PDF',
                thumbnail: 'https://placehold.co/200x200?text=PDF',
            },
            {
            ...
            },
            {
                ...
                date: '20/Jun/2024',
                description:
                    'Firmware and software for propulsion control systems.',
                type: 'PDF',
                thumbnail: 'https://placehold.co/200x200?text=PDF',
            },
            {
                ...
                date: '25/Jun/2024',
                description:
                    'Report detailing the surface treatment of propulsion materials.',
                type: 'DOC',
                thumbnail: 'https://placehold.co/200x200?text=DOC',
            },
        ],
        ...
        files: [
            {
                ...
                date: '18/Jan/2024',
                description:
                    "Detailed workflow for the navigation algorithm's architecture.",
                type: 'PDF',
                thumbnail: 'https://placehold.co/200x200?text=PDF',
            },
            {
                ...
                date: '12/Apr/2024',
                description:
                    'Source code repository for the navigation algorithm implementation.',
                type: 'DOC',
                thumbnail: 'https://placehold.co/200x200?text=DOC',
            },
            {
                ...
                date: '20/May/2024',
                description:
                    'Plan for validating navigation algorithm performance.',
                type: 'PDF',
                thumbnail: 'https://placehold.co/200x200?text=PDF',
            },
            {
                ...
                date: '30/Jun/2024',
                description:
                    'Surface treatment analysis for algorithm module housing.',
                type: 'DOC',
                thumbnail: 'https://placehold.co/200x200?text=DOC',
            },
        ],
        ...
        files: [
            {
                ...
                date: '01/Feb/2024',
                description:
                    'Manual detailing the design specifications of the battery module.',
                type: 'PDF',
                thumbnail: 'https://placehold.co/200x200?text=PDF',
            },
            {
            ...
            },
            {
                ...
                date: '30/Apr/2024',
                description:
                    'Software for managing battery charging and discharging cycles.',
                type: 'PDF',
                thumbnail: 'https://placehold.co/200x200?text=PDF',
            },
            {
                ...
                date: '05/Apr/2024',
                description:
                    'Analysis of the surface treatment for battery housing.',
                type: 'DOC',
                thumbnail: 'https://placehold.co/200x200?text=DOC',
            },
        ],
        ...
        files: [
            {
                ...
                date: '05/Feb/2024',
                description:
                    'Specifications for engineering the stability framework.',
                type: 'PDF',
                thumbnail: 'https://placehold.co/200x200?text=PDF',
            },
            {
                ...
                date: '15/May/2024',
                description:
                    'Checklist for quality assurance of stability features.',
                type: 'DOC',
                thumbnail: 'https://placehold.co/200x200?text=DOC',
            },
            {
                ...
                date: '12/Feb/2024',
                description:
                    'Algorithms for stability management in the flight system.',
                type: 'PDF',
                thumbnail: 'https://placehold.co/200x200?text=PDF',
            },
            {
                ...
                date: '10/Mar/2024',
                description:
                    'Details on the coating used for stability framework components.',
                type: 'DOC',
                thumbnail: 'https://placehold.co/200x200?text=DOC',
            },
        ],
    },
    {
        ...
        files: [
            ...
            },
            {
                ...
                date: '15/Apr/2024',
                description:
                    'Metrics for quality control in autopilot modules.',
                type: 'DOC',
                thumbnail: 'https://placehold.co/200x200?text=DOC',
            },
            {
                ...
                date: '10/Apr/2024',
                description:
                    'Source code for software controls used in autopilot systems.',
                type: 'PDF',
                thumbnail: 'https://placehold.co/200x200?text=PDF',
            },
            {
                ...
                date: '20/Apr/2024',
                description:
                    'Analysis of surface treatments applied to control module housing.',
                type: 'DOC',
                thumbnail: 'https://placehold.co/200x200?text=DOC',
            },
        ],
        ...
        files: [
            {
                ...
                date: '15/Jan/2024',
                description:
                    'Workflow for the development of aerodynamic structures.',
                type: 'PDF',
                thumbnail: 'https://placehold.co/200x200?text=PDF',
            },
            {
            ...
            },
            {
                ...
                date: '05/Mar/2024',
                description:
                    'Analysis of the surface treatment applied to wing structures.',
                type: 'DOC',
                thumbnail: 'https://placehold.co/200x200?text=DOC',
            },
        ],
        ...
        files: [
            {
                ...
                date: '05/Jun/2024',
                description:
                    'Framework specifications for emergency landing gear.',
                type: 'PDF',
                thumbnail: 'https://placehold.co/200x200?text=PDF',
            },
            {
                ...
                date: '15/Jun/2024',
                description:
                    'Validation results for emergency safety features.',
                type: 'DOC',
                thumbnail: 'https://placehold.co/200x200?text=DOC',
            },
            {
                ...
                date: '01/Jul/2024',
                description:
                    'Programming details for safety protocol automation.',
                type: 'PDF',
                thumbnail: 'https://placehold.co/200x200?text=PDF',
            },
            {
                ...
                date: '10/Jul/2024',
                description:
                    'Report on surface treatment processes for landing gear.',
                type: 'DOC',
                thumbnail: 'https://placehold.co/200x200?text=DOC',
            },
        ],
        ...
        files: [
            {
                ...
                date: '15/Dec/2023',
                description:
                    'Operational manual for the ground control system.',
                type: 'PDF',
                thumbnail: 'https://placehold.co/200x200?text=PDF',
            },
            {
                ...
                date: '05/Jan/2024',
                description:
                    'Quality assurance checklist for ground control systems.',
                type: 'DOC',
                thumbnail: 'https://placehold.co/200x200?text=DOC',
            },
            {
                ...
                date: '20/Jan/2024',
                description:
                    'Software used for operating ground control systems.',
                type: 'PDF',
                thumbnail: 'https://placehold.co/200x200?text=PDF',
            },
            {
                ...
                date: '25/Jan/2024',
                description:
                    'Details of the coating applied to the control system housing.',
                type: 'DOC',
                thumbnail: 'https://placehold.co/200x200?text=DOC',
            },
        ],
    },
    {
        ...
        files: [
            ...
            },
            {
                ...
                date: '25/Jan/2024',
                description:
                    'Checklist for quality validation of flight sensors.',
                type: 'DOC',
                thumbnail: 'https://placehold.co/200x200?text=DOC',
            },
            {
        ...
        files: [
            {
                ...
                date: '15/Mar/2024',
                description:
                    'Engineering workflow for the autonomous takeoff system.',
                type: 'PDF',
                thumbnail: 'https://placehold.co/200x200?text=PDF',
            },
            {
                ...
                date: '20/May/2024',
                description:
                    'Plan for validating takeoff system functionality.',
                type: 'DOC',
                thumbnail: 'https://placehold.co/200x200?text=DOC',
            },
            {
            ...
            },
            {
                ...
                date: '05/May/2024',
                description:
                    'Details of the coating process for takeoff system components.',
                type: 'DOC',
                thumbnail: 'https://placehold.co/200x200?text=DOC',
            },
        ],
        ...
        files: [
            {
                ...
                date: '15/Feb/2024',
                description:
                    'Workflow for energy system optimization in flight systems.',
                type: 'PDF',
                thumbnail: 'https://placehold.co/200x200?text=PDF',
            },
            {
                ...
                date: '01/Apr/2024',
                description:
                    'QA report on energy optimization system efficiency.',
                type: 'DOC',
                thumbnail: 'https://placehold.co/200x200?text=DOC',
            },
            {
                ...
                date: '20/Mar/2024',
                description:
                    'Algorithm for managing energy optimization in flight systems.',
                type: 'PDF',
                thumbnail: 'https://placehold.co/200x200?text=PDF',
            },
            {
                ...
                date: '25/Mar/2024',
                description:
                    'Surface coating process for energy module protection.',
                type: 'DOC',
                thumbnail: 'https://placehold.co/200x200?text=DOC',
            },
        ],
        ...
        files: [
            {
                ...
                date: '10/Jun/2024',
                description:
                    'Specifications for taxi deployment system components.',
                type: 'PDF',
                thumbnail: 'https://placehold.co/200x200?text=PDF',
            },
            {
                ...
                date: '20/Jul/2024',
                description:
                    'Checklist for quality assurance in taxi deployment systems.',
                type: 'DOC',
                thumbnail: 'https://placehold.co/200x200?text=DOC',
            },
            {
            ...
            },
            {
                ...
                date: '30/Jul/2024',
                description:
                    'Analysis of surface treatment for taxi deployment system.',
                type: 'DOC',
                thumbnail: 'https://placehold.co/200x200?text=DOC',
            },
        ],
    },
    {
        ...
        files: [
            ...
            },
            {
                ...
                date: '01/Jun/2024',
                description:
                    'Metrics for validating prototype landing gear assembly.',
                type: 'DOC',
                thumbnail: 'https://placehold.co/200x200?text=DOC',
            },
            {
            ...
            },
            {
                ...
                date: '25/Jun/2024',
                description:
                    'Surface treatment applied to landing gear components.',
                type: 'DOC',
                thumbnail: 'https://placehold.co/200x200?text=DOC',
            },
        ],
        ...
        files: [
            {
                ...
                date: '05/May/2024',
                description:
                    'Engineering documentation for flight dynamics simulator.',
                type: 'PDF',
                thumbnail: 'https://placehold.co/200x200?text=PDF',
            },
            {
            ...
            },
            {
                ...
                date: '30/May/2024',
                description:
                    'Details on surface treatments for simulator components.',
                type: 'DOC',
                thumbnail: 'https://placehold.co/200x200?text=DOC',
            },
        ],
        ...
        files: [
            {
                ...
                date: '15/Oct/2024',
                description:
                    'Engineering process for fail-safe protocol integration.',
                type: 'PDF',
                thumbnail: 'https://placehold.co/200x200?text=PDF',
            },
            {
                ...
                date: '25/Oct/2024',
                description:
                    'Checklist for quality validation of fail-safe protocols.',
                type: 'DOC',
                thumbnail: 'https://placehold.co/200x200?text=DOC',
            },
            {
                ...
                date: '01/Nov/2024',
                description:
                    'Codebase for emergency control protocol software.',
                type: 'PDF',
                thumbnail: 'https://placehold.co/200x200?text=PDF',
            },
            {
                ...
                date: '10/Nov/2024',
                description:
                    'Surface treatment details for fail-safe control components.',
                type: 'DOC',
                thumbnail: 'https://placehold.co/200x200?text=DOC',
            },
        ],
        ...
        files: [
            {
                ...
                date: '01/Aug/2024',
                description:
                    'Design specifications for the charging dock station.',
                type: 'PDF',
                thumbnail: 'https://placehold.co/200x200?text=PDF',
            },
            {
                ...
                date: '10/Sep/2024',
                description:
                    'Checklist for ensuring quality standards for charging docks.',
                type: 'DOC',
                thumbnail: 'https://placehold.co/200x200?text=DOC',
            },
            {
            ...
            },
            {
                ...
                date: '25/Sep/2024',
                description:
                    'Report on coating applications for charging dock surfaces.',
                type: 'DOC',
                thumbnail: 'https://placehold.co/200x200?text=DOC',
            },
        ],
        ...
        files: [
            {
                ...
                date: '10/Nov/2024',
                description:
                    'Design guidelines for flight stabilizer components.',
                type: 'PDF',
                thumbnail: 'https://placehold.co/200x200?text=PDF',
            },
            {
                ...
                date: '20/Nov/2024',
                description:
                    'Quality report for stabilizer module functionality.',
                type: 'DOC',
                thumbnail: 'https://placehold.co/200x200?text=DOC',
            },
            {
                ...
                date: '01/Dec/2024',
                description:
                    'Code for stabilization algorithms in the flight system.',
                type: 'PDF',
                thumbnail: 'https://placehold.co/200x200?text=PDF',
            },
            {
                ...
                date: '15/Dec/2024',
                description:
                    'Analysis of surface treatments for stabilizer module protection.',
                type: 'DOC',
                thumbnail: 'https://placehold.co/200x200?text=DOC',
            },
        ],
        ...
        files: [
            {
                ...
                date: '05/Jan/2025',
                description:
                    'Specifications for emergency control override systems.',
                type: 'PDF',
                thumbnail: 'https://placehold.co/200x200?text=PDF',
            },
            {
                ...
                date: '15/Jan/2025',
                description:
                    'Quality checklist for emergency system components.',
                type: 'DOC',
                thumbnail: 'https://placehold.co/200x200?text=DOC',
            },
            {
                ...
                date: '25/Jan/2025',
                description:
                    'Firmware for managing emergency control operations.',
                type: 'PDF',
                thumbnail: 'https://placehold.co/200x200?text=PDF',
            },
            {
                ...
                date: '05/Feb/2025',
                description:
                    'Analysis of coating applied to emergency system housing.',
                type: 'DOC',
                thumbnail: 'https://placehold.co/200x200?text=DOC',
            },
        ],
