...
import FilesSectionComponent from './FilesSectionComponent';
...
describe('FilesSectionComponent', () => {
    ...
    it('renders empty files component when no files are provided', () => {
        render(<FilesSectionComponent selectedTab="All Categories" onTabChange={mockOnTabChange} filteredFiles={[]} />);
